...
with tab2:
    st.warning("⚠️ Download your PDF & CSV before closing this page — data will not be saved after you leave." if EN else "⚠️ Pobierz PDF i CSV zanim zamkniesz strone — dane nie beda zapisane po wyjsciu.")
